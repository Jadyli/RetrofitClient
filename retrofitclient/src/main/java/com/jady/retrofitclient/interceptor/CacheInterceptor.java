...
import com.jady.retrofitclient.cache.CacheHelper;
import com.jady.retrofitclient.cache.CacheModel;
...
public class CacheInterceptor implements Interceptor {
    ...
    public CacheInterceptor(Context mC, boolean isOnlineCache) {
        this.mC = mC;
        this.isOnlineCache = isOnlineCache;
        cacheHelper = new CacheHelper(mC);
    }

    public CacheInterceptor(Context mC, boolean isOnlineCache, int online_time) {
        this.mC = mC;
        this.isOnlineCache = isOnlineCache;
    ...
    public static CacheInterceptor create(Context mC) {
        return new CacheInterceptor(mC);
    }
    public static CacheInterceptor create(Context mC, boolean isOnlineCache) {
        return new CacheInterceptor(mC,isOnlineCache);
    }
    public static CacheInterceptor create(Context mC, boolean isOnlineCache, int online_time) {
        return new CacheInterceptor(mC,isOnlineCache,online_time);
    }
    ...
    private Response cacheForGet(Request request, Chain chain) throws IOException {
        if (!NetworkUtils.isNetworkConnected(this.mC)) {
